...
// --- set by RAFX
const AAX_CTypeID cRAFX_ManufactureID =			'asdf';
const AAX_CTypeID cRAFX_ProductID =				'asdf';
const AAX_CTypeID cRAFX_TypeID_MonoNative =		'RxMN';
const AAX_CTypeID cRAFX_TypeID_StereoNative =	'RxST';
const unsigned int RAFX_AAX_Category = AAX_ePlugInCategory_None;
...
#define kSynchronizedParameterQueueSize 4 // set with RAFX [Make AAX]
