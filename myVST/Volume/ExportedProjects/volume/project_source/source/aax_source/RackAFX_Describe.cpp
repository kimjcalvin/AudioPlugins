...
// --- set by RAFX
AAX_CEffectID kRackAFX_EffectID = "rackafx.volume";
...
AAX_Result GetRackAFXPlugInDescription(AAX_IEffectDescriptor&	outDescriptor)
{
	...
	// --- Effect identifiers
	outDescriptor.AddName("Volume");
	outDescriptor.AddName("vol"); // short version is placed in mixer channel's insert box
...
AAX_Result GetEffectDescriptions ( AAX_ICollection * outCollection )
{
	...
	outCollection->SetManufacturerName("RackAFX User");
